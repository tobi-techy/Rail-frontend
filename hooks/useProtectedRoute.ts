...
export function useProtectedRoute() {
  ...
  const authState: AuthState = {
    ...
    pendingVerificationMode: useAuthStore((state) => state.pendingVerificationMode),
  ...
  useEffect(() => {
    ...
    const currentAuthState: AuthState = {
      ...
      pendingVerificationMode: freshAuthState.pendingVerificationMode,
    ...
    authState.pendingVerificationMode,
