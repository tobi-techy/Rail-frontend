  ...
  useEffect(() => {
    ...
    const initializeApp = async () => {
      ...
      try {
        ...
        // Get fresh state without artificial delays
        ...
        if (hasValidAuthData) {
          // Simplified token validation - always validate in production
        ...
        // Still set ready even on error to prevent infinite loading
      } finally {
        setIsReady(true);
