  ...
  return (
    <View className="flex-1 px-6 pt-6">
      ...
      <TouchableOpacity
        ...
        <View className="flex-1 flex-row items-center">
          ...
          <View className="flex-1">
            ...
            <Text className="font-body-medium text-[14px] text-[#848281]">
        ...
        <View className="items-end">
          ...
          <Text
            className={`font-body-bold text-[14px] ${
              (selectedToken?.priceChange || 0) >= 0 ? 'text-meadow-green' : 'text-coral-red'
            }`}>
      ...
      <View className="mb-8 items-center">
        ...
        <Text className="font-body-medium text-[24px] text-[#848281]">${usdValue}</Text>
      </View>
