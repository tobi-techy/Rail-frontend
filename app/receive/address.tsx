...
export default function ReceiveAddressScreen() {
  ...
  }, [isError, error, chain, provisioning, provisionWallet, refetch]);
    ...
    <SafeAreaView className="flex-1 bg-warm-canvas" edges={['top']}>
      ...
      <View className="flex-row items-center justify-between px-5 pb-2 pt-1">
        ...
        <Pressable
          className="size-11 items-center justify-center rounded-full bg-surface"
          onPress={() => refetch()}>
          <HugeiconsIcon icon={RefreshIcon} size={18} color="#848281" />
        </Pressable>
      </View>
        ...
        {isReady ? (
          <View>
            <View className="items-center justify-center">
              ...
              <View
                className="absolute items-center justify-center rounded-full bg-warm-canvas"
                style={{
                  width: 64,
                  height: 64,
                  elevation: 4,
