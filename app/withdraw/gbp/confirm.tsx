    ...
    <SafeAreaView className="flex-1 bg-warm-canvas" edges={['top']}>
      ...
      <ScrollView
        ...
        <Animated.View entering={FadeInUp.duration(250)} className="items-center py-8">
          ...
          <Text className="mt-1 font-body text-[14px] text-text-secondary">GBP</Text>
        </Animated.View>
        ...
        <Animated.View entering={FadeInUp.delay(40).duration(250)}>
          <ReviewCard title="Bank Details">
            ...
            <Sep />
            <DetailRow label="Sort code" value={formatSortCode(params.sortCode ?? '')} />
            <Sep />
            <DetailRow
              label="Account"
            ...
            />
            <Sep />
            <DetailRow label="Currency" value="GBP" />
            <Sep />
