      ...
      <ScrollView
        ...
        <Animated.View entering={FadeInUp.delay(100).duration(250)} className="mt-5">
          <Pressable
            ...
            onPress={() => {
              router.push({
                pathname: '/withdraw/gbp/new-recipient' as never,
                params: { amount: params.amount, currency: 'GBP' },
              } as never);
            }}>
          ...
          {filtered.length === 0 ? (
            ...
            filtered.map((r, i) => (
              <RecipientRow
                ...
                subtitle={`${formatSortCode(r.routingNumber)} | ••••${r.accountNumber.slice(-4)}`}
                index={i}
