  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="flex-1">
        ...
        <View className="mt-2 px-6 flex-row items-center justify-end">
          <TouchableOpacity
            onPress={handleNeedHelp}
            className="flex-row items-center gap-x-2 rounded-full bg-[#EEF2FF] px-4 py-2.5"
            activeOpacity={0.7}
          >
            <Icon name="message-circle" size={18} color="#6366F1" strokeWidth={2} />
        ...
        {/* Footer */}
        <View className="mb-4 px-6 items-center gap-y-3">
